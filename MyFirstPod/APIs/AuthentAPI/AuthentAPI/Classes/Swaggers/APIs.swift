...
open class AuthentAPIAPI {
    open static var basePath = "http://localhost/CAP-US_AccesEC"
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:Any]?, isBody: Bool, headers: [String:String] = [:]) {
        ...
        addHeaders(AuthentAPIAPI.customHeaders)
    }
    ...
    open func addCredential() -> Self {
        self.credential = AuthentAPIAPI.credential
        return self
    }
}
